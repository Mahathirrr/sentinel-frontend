...
<template>
  <section
    class="container mt-10 flex max-w-5xl flex-col-reverse gap-8 md:mt-14 md:gap-14 lg:mt-20 lg:flex-row lg:items-end"
  >
    <!-- Images Left - Text Right -->
    <div class="flex flex-col gap-8 lg:gap-16 xl:gap-20">
      <ImageSection
        :images="[
          { src: '/about/1.webp', alt: 'Team collaboration' },
          { src: '/about/2.webp', alt: 'Team workspace' },
        ]"
        class="xl:-translate-x-10"
      />
      ...
      <TextSection
        ...
        :cta-button="{ href: '/careers', text: 'View open roles' }"
      />
    </div>
    ...
    <div class="flex flex-col gap-8 lg:gap-16 xl:gap-20">
      ...
      <ImageSection
        ...
        class="hidden lg:flex xl:translate-x-10"
      />
    </div>
  </section>
</template>
